...
b) Địa chỉ IP lớp B
  ...
  !(https://github.com/hynhdih/Training_OM/assets/82271913/0835a0be-f995-47cf-8a97-b9cc6b1bb0f2)
...
> [!TIP]
> Lớp A: Giá trị từ **1 -> 126** với địa chỉ IP từ **1.0.0.0 -> 126.0.0.0 /8** ; **Private class A: 10.0.0.0 -> 10.255.255.255**
## 2. Địa chỉ IP Public

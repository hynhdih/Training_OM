...
## 5. Địa chỉ IP động
  ...
  - Các đơn vị cung cấp dịch vụ Internet thường sẽ chỉ cung cấp địa chỉ IP động cho khách hàng thông thường. Tức là, IP sẽ khác nhau sau mỗi lần kết nối hoặc trong một phiên kết nối sẽ được đổi thành các IP khác.
    => Tiết kiệm nguồn địa chỉ IP đang có hạn. Khi một thiết bị đang không kết nối vào mạng Internet thì nhà cung cấp sẽ cấp IP đó cho một người sử dụng khác.
